...
description: 为 GETO 按单一产品技术面或商业角色召回竞对候选，并在一家公司一个独立任务中核验产品商业控制、制造与履约模式，再沿确认竞对的官方项目案例反查未来可合作客户。用于模架、装配式、模块化、租赁经销与材料生态的竞对发现和客户反查；不凭公司名称或关键词确认竞对，不生成威胁总分或直接上传 OmniX。
---
...
按 [output-contract.md](references/output-contract.md) 保存候选、竞对分类建议、拒绝理由、官方案例关系和新公司名单。回传做了什么、成果路径、接受/拒绝理由、缺口和下一步。不得输出 Company/Claim/Source 技术 Key、ResearchDelta、威胁总分或 OmniX Draft 状态。
